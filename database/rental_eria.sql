...
(1, 'Rental Mobil \r\nJl. Lk. Timur, Panorama, Kec. Singaran Pati, Kota Bengkulu, 38226\r\n', 'rentalmobil_semaku@gmail.com', '+6283801188807');
...
(5, 'Rekening', 'rekening', '																																	123456789 Bank BRI a/n INDRA YOGA WIDIANTO'),
(0, 'Driver', 'driver', '450000'),
(2, 'Privacy Policy', 'privacy', '<span style=\"color: rgb(0, 0, 0); font-family: &quot;Open Sans&quot;, Arial, sans-serif; font-size: 14px; text-align: justify;\"> Halaman ini memberi tahu Anda tentang kebijakan kami mengenai pengumpulan, penggunaan, dan pengungkapan data pribadi saat Anda menggunakan Layanan kami dan pilihan yang Anda miliki terkait dengan data itu. Kebijakan Privasi ini untuk Mobil wilayah SEMAKU(Seluma-Manna-Kaur)
...
Data Penggunaan
Kami juga dapat mengumpulkan informasi tentang bagaimana Layanan diakses dan digunakan (“Data Penggunaan”). Data Penggunaan ini dapat mencakup informasi seperti alamat Protokol Internet komputer Anda (misalnya alamat IP), jenis peramban, versi peramban, laman Layanan kami yang Anda kunjungi, waktu dan tanggal kunjungan Anda, waktu yang dihabiskan untuk laman tersebut, unik pengidentifikasi perangkat dan data diagnostik lainnya.
Data Pelacakan & Cookie
...
Cookie adalah file dengan sejumlah kecil data yang mungkin termasuk pengidentifikasi unik anonim. Cookie dikirim ke browser Anda dari situs web dan disimpan di perangkat Anda. Teknologi pelacakan juga digunakan adalah beacon, tag, dan skrip untuk mengumpulkan dan melacak informasi dan untuk meningkatkan dan menganalisis Layanan kami.
...
Cookie Sesi. Kami menggunakan Cookie Sesi untuk mengoperasikan Layanan kami. Cookies Preferensi. Kami menggunakan Cookies Preferensi untuk mengingat preferensi Anda dan berbagai pengaturan. Cookie Keamanan. Kami menggunakan Cookie Keamanan untuk tujuan keamanan.
Penggunaan Data
rentalmobil_semaku menggunakan data yang dikumpulkan untuk berbagai tujuan:
Untuk menyediakan dan memelihara Layanan
Untuk memberitahukan Anda tentang perubahan didalam pelayanan kami
Untuk memungkinkan Anda berpartisipasi dalam fitur interaktif dari Layanan kami ketika Anda memilih untuk melakukannya
Untuk memberikan layanan dan dukungan pelanggan
Untuk memberikan analisis atau informasi berharga agar kami dapat meningkatkan Layanan
Untuk memantau penggunaan Layanan
Untuk mendeteksi, mencegah, dan mengatasi masalah teknis
Transfer Data
Informasi Anda, termasuk Data Pribadi, dapat ditransfer ke – dan dipelihara di – komputer yang terletak di luar negara bagian Anda, provinsi, negara atau yurisdiksi pemerintah lainnya di mana undang-undang perlindungan data dapat berbeda dari yang berasal dari yurisdiksi Anda.
Jika Anda berada di luar Indonesia dan memilih untuk memberikan informasi kepada kami, harap dicatat bahwa kami mentransfer data, termasuk Data Pribadi, ke Indonesia dan memprosesnya di sana.
Persetujuan Anda terhadap Kebijakan Privasi ini diikuti dengan penyerahan Anda atas informasi tersebut merupakan persetujuan Anda untuk transfer itu.
rentalmobil_semaku akan mengambil semua langkah yang diperlukan secara wajar untuk memastikan bahwa data Anda diperlakukan dengan aman dan sesuai dengan Kebijakan Privasi ini dan tidak ada pengalihan Data Pribadi Anda akan dilakukan ke organisasi atau negara kecuali ada kontrol yang memadai termasuk keamanan data Anda dan informasi pribadi lainnya.
Pengungkapan Data
Persyaratan resmi
rentalmobil_semaku dapat mengungkapkan Data Pribadi Anda dengan itikad baik bahwa tindakan tersebut diperlukan untuk:
Untuk mematuhi kewajiban hukum
Untuk melindungi dan membela hak atau milik rentalmobil_semaku
...
Anda dapat memilih untuk tidak menjadikan aktivitas Anda di Layanan tersedia untuk Google Analytics dengan menginstal add-on browser Google Analytics opt-out. Pengaya ini mencegah JavaScript Google Analytics (ga.js, analytics.js, dan dc.js) dari berbagi informasi dengan Google Analytics tentang aktivitas kunjungan. Untuk informasi lebih lanjut tentang praktik privasi Google, kunjungi halaman web Privasi Google & Ketentuan: https://policies.google.com/privacy?hl=id
Tautan ke Situs Lain
Layanan kami mungkin berisi tautan ke situs lain yang tidak dioperasikan oleh kami. Jika Anda mengklik tautan pihak ketiga, Anda akan diarahkan ke situs pihak ketiga itu. Kami sangat menyarankan Anda untuk meninjau Kebijakan Privasi dari setiap situs yang Anda kunjungi.
...
Kami akan memberi tahu Anda melalui email dan / atau pemberitahuan yang menonjol di Layanan kami, sebelum perubahan menjadi efektif dan memperbarui “tanggal efektif” di bagian atas Kebijakan Privasi ini.
Anda disarankan untuk meninjau Kebijakan Privasi ini secara berkala untuk setiap perubahan. Perubahan pada Kebijakan Privasi ini efektif ketika mereka diposting di halaman ini.
Hubungi kami
Jika Anda memiliki pertanyaan tentang Kebijakan Privasi ini, silakan hubungi kami:
Melalui email: indrawhidy@gmail.com </span>'),
